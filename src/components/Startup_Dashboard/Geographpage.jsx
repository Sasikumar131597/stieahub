    ...
    <Toolbar disableGutters>
      <Box sx={{ flexGrow: 1, display: 'flex' }}>
        <NavButton 
          ...
          className={window.location.pathname === '/startup_dashboard' ? 'active' : ''}
        >
          Home
        </NavButton>
        <NavButton 
          onClick={() => navigate('/startup_dashboard/industries')}
          className={window.location.pathname === '/startup_dashboard/industries' ? 'active' : ''}
        >
          Industries
        </NavButton>
        <NavButton 
          onClick={() => navigate('/startup_dashboard/geography')}
          className={window.location.pathname === '/startup_dashboard/geography' ? 'active' : ''}
        >
          Geography
        </NavButton>
      </Box>
