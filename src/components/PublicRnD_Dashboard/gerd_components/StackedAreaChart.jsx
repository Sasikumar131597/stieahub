    ...
    <div className="stacked-area-chart-container">
      ...
      <div className="chart-wrapper">
        <Line ref={chartRef} data={data} options={options} />
          ...
          <p style={{fontSize:"12px",textAlign:"center"}}><b>Source: </b>Data on Public R&D, Central Sector R&D and State Sector R&D expenditures are from NSTMIS, Department of Science and Technology, Government of India</p>
    </div>
  );
};
