...
function PublicRnd() {
    ...
    return (
        <main className="p-4">
            ...
            <div className="box flex justify-between items-center" style={{ width: "93%", margin: "20px auto", padding: "15px" }}>
                ...
                <p style={{fontSize:"12px",textAlign:"center"}}><b>Source: </b>Data on Central Sector R&D and State Sector R&D expenditures are from NSTMIS, Department of Science and Technology, Government of India
               </p>
            </div>

            <div className="text-center my-6">
                <h2 className="section-title">Public R&D Intensity</h2>
            </div>
